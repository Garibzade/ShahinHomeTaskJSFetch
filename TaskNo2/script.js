...
var ar =
  [{
    ...
    "network": {
      ...
      "officialSite": "https://static.tvmaze.com/uploads/images/original_untouched/81/202627.jpg"
    },
    "webChannel": null,
    "dvdCountry": null,
    "externals": {
...
function getCharacters(data) {
  ...
  data.forEach(elem => {
    area.innerHTML += `
      <div class="col-md-3">
        <div class="card">
          <img src="${elem.image.medium}" class="card-img-top" alt="${elem.name}" />
          <div class="card-body">
            <h5 class="card-title">${elem.name}</h5>
            <p class="card-text">${elem.name}  <br/> ${elem.rating.average}</p>
...
searchForm.addEventListener('submit', function (event) {
  ...
  const searchInput = document.getElementById("film-input");
